...
public abstract class BwaAlignmentBase implements Serializable {
	...
	*/
	public BwaAlignmentBase(ExecutionEnvironment env, Bwa bwaInterpreter) {

		this.appId			= env.getId().toString();
		this.appName		= "flink-bwa";
		this.tmpDir			= "/tmp"; //TODO: get temporary dir form params
