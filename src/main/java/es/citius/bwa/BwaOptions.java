...
public class BwaOptions {
	...
	private String footer = "\nPlease report issues at josemanuel.abuin@usc.es or ifrim.claudia@gmail.com";
	...
	private void printHelp() {
		...
		System.out.println("FlinkBWA performs genomic alignment using bwa in Flink on a Hadoop/YARN cluster");
	...
	/**
	 * Constructor to use from within FlinkkBWA from the Linux console
	 *
